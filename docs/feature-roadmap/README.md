...
|---|---|---|---|
| 01 | [Fix hardcoded currency symbol](issues/01-fix-hardcoded-currency-symbol.md) | None | Ready |
...
| 04 | [Siri/Shortcuts quick-add expense](issues/04-siri-shortcuts-quick-add-expense.md) | None | In review - [PR #25](https://github.com/ictech-projects/finance-test-ios/pull/25) |
| 05 | [Control Center "Add Expense" control](issues/05-control-center-add-expense-control.md) | 04 | Blocked (unblocks once PR #25 merges) |
| 06 | [Siri/Shortcuts balance & spend queries](issues/06-siri-shortcuts-balance-spend-queries.md) | 04 | Blocked (unblocks once PR #25 merges) |
...
| 13 | [Conversational Siri chaining (stretch)](issues/13-conversational-siri-chaining.md) | 04 | Blocked (unblocks once PR #25 merges) |
...
frontier and ready to go - currently that's 01, 02, 07, 09, 11, 12, and 14 (04 is in review;
15 is merged). Check a ticket's box items off as you satisfy them; this repo doesn't yet
auto-update ticket status, so mark it done in the file itself when you finish.
