...
extension Color {
	static let recordsCardBackground = Color(
		light: Color(red: 0xF4 / 255, green: 0xF2 / 255, blue: 0xFC / 255),
		dark: Color(red: 0x1F / 255, green: 0x1E / 255, blue: 0x24 / 255)
	)
	static let recordsCardBorder = Color(
		light: Color(red: 0xC5 / 255, green: 0xC5 / 255, blue: 0xD4 / 255),
		dark: Color(red: 0x72 / 255, green: 0x72 / 255, blue: 0x7A / 255)
	)
	static let recordsChipSelectedBackground = Color(
		light: Color(red: 0xDC / 255, green: 0xDE / 255, blue: 0xF7 / 255),
		dark: Color(red: 0x35 / 255, green: 0x37 / 255, blue: 0x4C / 255)
	)
	static let recordsDiningIconBackground = Color(
		light: Color(red: 0xFF / 255, green: 0xDA / 255, blue: 0xD6 / 255),
		dark: Color(red: 0x33 / 255, green: 0x22 / 255, blue: 0x20 / 255)
	)
	static let recordsNeutralIconBackground = Color(
		light: Color(red: 0xE3 / 255, green: 0xE1 / 255, blue: 0xEA / 255),
		dark: Color(red: 0x2D / 255, green: 0x2C / 255, blue: 0x33 / 255)
	)

	// Icon glyph tints (the SVG `fill` colors), distinct from the pastel circle backgrounds above.
	static let recordsDiningIconTint = Color(
		light: Color(red: 0x93 / 255, green: 0x00 / 255, blue: 0x0A / 255),
		dark: Color(red: 0xC7 / 255, green: 0x00 / 255, blue: 0x0E / 255)
	)
	static let recordsNeutralIconTint = Color(
